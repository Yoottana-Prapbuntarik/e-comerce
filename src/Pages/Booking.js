            ...
            <div>
                <React.Fragment>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-6 col-12 BookingStyle my-5 mb-2">
                                <div className="container-fluid">
                                    <div className="row  text-center">
                                        ...
                                        <div className="col-lg-6 col-12 mt-2 ">
                                            <img className="img-responsive" src={scb} alt="SCB" width="250px" />
                                        </div>
                                        ...
                                        <div className="col-lg-6 col-12 mt-2 ">
                                            ...
                                            <img className="img-responsive" src={KrungSri} alt="KrungSri" width="250px" />
                                        </div>
                                        <div className="col-lg-6 col-12 mt-3 font-weight-bold text-left">
                                        ...
                                        <div className="col-lg-6 col-12 mt-2 ">
                                            <img className="img-responsive" src={Kasikorn} alt="Kasikorn" width="250px" />
                                        </div>
                                        <div className="col-lg-6 col-12 mt-3 font-weight-bold text-left">
                            ...
                            <div className="col-md-6 col-12 buttonBooking text-center mb-5 marginTop">
                                ...
                                <NavLink className="btn  btn-color-pink-Address  text-white w-100 mt-4" to={`/ConfirmPayment`}><span className="Text-Confirm-Button ">ไปหน้าแจ้งการชำระเงิน</span></NavLink>

                                <br />
                                <NavLink className="btn btn btn-color-pink-Address  bg-white text-pink w-100 my-3" to="/"><span className="Text-Confirm-Button ">ไปหน้าแรก</span></NavLink>
